...
🤖 AI-Based Optimization: Dynamically adjusts traffic signal timings using ML models

🚦 Adaptive Signal Control: Reduces wait time and congestion at intersections

📊 Smart Dashboard: Visualizes traffic patterns, congestion levels, and signal states

🔔 Event Detection: Identifies unusual traffic conditions (e.g., heavy congestion spikes)
